...
class adefip_eligibilite_activite(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        TypesContratDeTravail = contrat_de_travail_type.possible_values
        ...
        condition_cdd = not_(condition_formation) * (contrat_de_travail_type == TypesContratDeTravail.cdd) * condition_duree_cdd

        # cas CDI
        condition_cdi = not_(condition_formation) * (contrat_de_travail_type == TypesContratDeTravail.cdi)
...
class adefip_montant(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        contrat_de_travail_type = individu('contrat_de_travail_type', period)
        TypesContratDeTravailType = contrat_de_travail_type.possible_values
        ...
        est_en_cdd = contrat_de_travail_type == TypesContratDeTravailType.cdd
        ...
        # cas CDI temps plein
        est_en_cdi = contrat_de_travail_type == TypesContratDeTravailType.cdi
